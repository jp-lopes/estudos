...
modelo_scip.setObjective(x1_scip + 2* x2_scip, sense="minimize")

# 4. Montar as Restrições (usamos addCons no SCIP)
modelo_scip.addCons(-x1_scip + x2_scip >= b1, name="Restricao_1")
modelo_scip.addCons(x1_scip + x2_scip <= b2, name="Restricao_2")
modelo_scip.addCons(x1_scip >= b3, name="Restricao_3")
modelo_scip.addCons(x2_scip >= b4, name="Restricao_4")
