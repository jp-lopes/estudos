...
modelo_scip.setObjective(c * x1_scip + (c+4) * x2_scip, sense="maximize")

# 4. Montar as Restrições (usamos addCons no SCIP)
modelo_scip.addCons(10 * x1_scip + 18 * x2_scip <= 52, name="Restricao_1")
modelo_scip.addCons(-1 * x1_scip + 1 * x2_scip <= 2, name="Restricao_2")
